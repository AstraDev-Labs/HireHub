...
export default function EditChallengePage() {
        ...
        const fetchChallenge = async () => {
            try {
                ...
                setFormData({
                    ...
                    topicTags: challenge.topicTags || [],
                    constraints: challenge.constraints || '',
                    testCases: challenge.testCases?.length ? challenge.testCases : [{ input: '', output: '', isSample: true }],
                    codeSnippets: challenge.codeSnippets?.length 
                        ? challenge.codeSnippets.filter((v: any, i: number, a: any[]) => a.findIndex(t => t.language === v.language) === i)
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setSubmitting(true);
        try {
            await api.patch(`/challenges/${id}`, formData);
    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-4">
                ...
                <p className="text-muted-foreground font-medium animate-pulse text-lg">Loading challenge details...</p>
            </div>
        );
    }
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex items-center gap-4 mb-8">
                ...
                <h1 className="text-3xl font-bold flex items-center gap-2">
                    <Save className="w-8 h-8 text-primary" /> Edit Challenge
                </h1>
            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <Card className="border-border shadow-sm">
                            <CardHeader>
                                ...
                                <CardDescription>Update the title and main description of the coding problem.</CardDescription>
                            </CardHeader>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="sticky top-8">
                            ...
                            <p className="text-xs text-center text-muted-foreground mt-4">Changes will be visible to all students immediately.</p>
                        </div>
                    </div>
                </div>
            </form>
