...
def check_page(file_path: Path) -> dict:
    ...
    # Detect if this is a layout/template file (has Head component or exports metadata)
    is_layout = 'Head>' in content or '<head>' in content.lower() or '<head ' in content.lower() or 'export const metadata' in content
